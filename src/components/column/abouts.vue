<template>
	<div id="about">
		<div class="about-banner">
			<img src="/static/img/about-01.png" />
		</div>
		<div class="about-main">
			...
			<div class="about-img02">
				<img src="/static/img/about-02.png" />
			</div>
			<h2>
				We are the leading filtration company in Asia that provides a full range of development, designing and manufacturing capabilities.
			</h2>
			<p>
			...
			<div class="about-img03">
				<img src="/static/img/about-03.png" />
			</div>
			<p>
